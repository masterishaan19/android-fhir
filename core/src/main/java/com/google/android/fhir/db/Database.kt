...
interface Database {
   ...
   * server. Each [resource] will have at most one [LocalChange](multiple changes are squashed).
   */
  suspend fun getAllLocalChanges(): List<Pair<LocalChangeToken, LocalChange>>
